...
func main() {
	...
	wnd.MainLoop(func() {
		...
		rule(green, green, -0.99)
		rule(green, red, -0.1618033)
		rule(green, yellow, 0.32)
		rule(red, red, -0.1618033)
		rule(red, green, -0.314159)
		rule(yellow, yellow, 0.618033)
		rule(yellow, green, -0.2564)
